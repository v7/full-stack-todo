...
class Signup extends Component {
  ...
  render () {
    return (
      <Form size='large' style={{width: '50vw', minWidth: 300,alignSelf: 'center'}} onSubmit={this.handleSubmit}>
      <Segment stacked>
        <Form.Input
          fluid
          icon='user'
        ...
        <Button type='submit' style={{backgroundColor: '#2c3e50'}} secondary fluid size='large'>Login</Button>
        <Link to='/'>Login</Link>
      </Segment>
      <Message
      error
